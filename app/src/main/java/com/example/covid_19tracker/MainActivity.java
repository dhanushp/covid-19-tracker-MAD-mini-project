...
//    }
    ...
    private void FetchData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                Request.Method.GET,
                apiUrl,
                null, //JSONObject sent to server
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        JSONArray total_state_jsonArray = null;

                        try {
                            all_state_jsonArray = response.getJSONArray("statewise");
                            total_state_jsonArray = response.getJSONArray("cases_time_series");
                            ...
                            str_confirmed_new = total_data.getString("dailyconfirmed");   //New Confirmed cases from last update time
                            ...
                            str_recovered_new = total_data.getString("dailyrecovered"); //New recovered cases from last update time

                            str_death = data_india.getString("deaths");     //Total deaths in India
                            str_death_new = total_data.getString("dailydeceased");    //New death cases from last update time
                            ...
                            delayToshowProgess.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    tv_confirmed.setText(NumberFormat.getInstance(new Locale("en", "IN")).format(Integer.parseInt(str_confirmed)));
